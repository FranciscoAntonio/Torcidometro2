...
public class LivroHTTP {
    ...
    public static final String LIVROS_URL_JSON = "https://raw.githubusercontent.com/" +
            "nglauber/dominando_android2/master/livros_novatec.json";
    ...
    private static List<Livro> lerJsonLivros(JSONObject json) throws JSONException {
